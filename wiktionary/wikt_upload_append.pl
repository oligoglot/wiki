...
$b->submit();
open( OUT, ">>notappended.out" )
  or die
"Can't write to notappended.out. Please check if you have permissions on this directory. $!\n";
open( ERR, ">>appendDEBUG.txt" )
  or die
"Can't write to DEBUG.txt. Please check if you have permissions on this directory. $!\n";
open( IN, "alreadyfound.out" )
  or die
